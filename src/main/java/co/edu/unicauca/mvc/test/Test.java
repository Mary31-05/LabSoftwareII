...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        RepositorioOrganizadorMemoriaLinkedist objRepositorio3 = new RepositorioOrganizadorMemoriaLinkedist();
        ...
        objVtnPrincipal.asociarServicios(objServicio1, objServicio2, objServicio3, objServicio4); 
